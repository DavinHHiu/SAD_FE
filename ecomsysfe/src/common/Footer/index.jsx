...
export default function Footer() {
    return (
        <div className={style.footer_container}>
            <div className={style.footer_above_container}>
                <div className={style.service_container}>
                    <div className="iaSrUz">
                        <div className={style.service_title}>CHĂM SÓC KHÁCH HÀNG</div>
                        <ul className={style.service_list}>
                            <li className={style.service_item}>
                                <span>Trung Tâm Trợ Giúp</span>
                            </li>
                            <li className={style.service_item}>
                                <span className="DMQMn2">PriceTag Blog</span>
                            </li>
                            <li className={style.service_item}>
                                <span className="DMQMn2">PriceTag Mall</span>
                            </li>
                            <li className={style.service_item}>
                            ...
                            <li className={style.service_item}>
                                <span className="DMQMn2">PriceTag Xu</span>
                            </li>
                            <li className={style.service_item}>
                    ...
                    <div className="iaSrUz">
                        <div className={style.service_title}>VỀ PRICE TAG</div>
                        <ul className={style.service_list}>
                            <li className={style.service_item}>
                                <span className="DMQMn2">Giới Thiệu Về PriceTag Việt Nam</span>
                            </li>
                            <li className={style.service_item}>
                                <span className="DMQMn2">Tuyển Dụng</span>
                            </li>
                            <li className={style.service_item}>
                                <span className="DMQMn2">Điều Khoản PriceTag</span>
                            </li>
                            <li className={style.service_item}>
                            ...
                            <li className={style.service_item}>
                                <span className="DMQMn2">Chương Trình Tiếp Thị Liên Kết PriceTag</span>
                            </li>
                            <li className={style.service_item}>
                    ...
                    <div className="iaSrUz">
                        <div className={style.service_title}>THANH TOÁN</div>
                        <ul className={style.cor_list}>
                        ...
                        <div className={style.service_title}>ĐƠN VỊ VẬN CHUYỂN</div>
                        <ul className={style.cor_list}>
                            <li className={style.logo_item}>
                                <img
                    ...
                    <div className="iaSrUz">
                        <div className={style.service_title}>THEO DÕI CHÚNG TÔI TRÊN</div>
                        <ul className={style.service_list}>
                    ...
                    <div className="iaSrUz">
                        <div className={style.service_title}>TẢI ỨNG DỤNG PRICETAG NGAY THÔI</div>
                        <div className={style.app_store_container}>
                            <img
                                src="https://down-vn.img.susercontent.com/file/a5e589e8e118e937dc660f224b9a1472"
                                alt="download_qr_code"
                                className={style.logo_item}
                            />
                            <div className={style.app_store}>
                                <img
                                    className={style.logo_item}
            ...
            <div className={style.footer_below_container}>
                <div className={style.info_container}>
                    <div className={style.regular_container}>
                        ...
                        <div className={style.regular_last}>
                            <span>CHÍNH SÁCH TRẢ HÀNG VÀ HOÀN TIỀN</span>
                        </div>
                    </div>
                    <div className={style.cor_name}>Công ty TNHH PriceTag</div>
                    ...
                    <div className={style.info}>© 2015 - Bản quyền thuộc về Công ty TNHH PriceTag</div>
                </div>
            </div>
        </div>
    );
